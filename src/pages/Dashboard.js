    ...
    <div className='w-full dark:bg-[#262829] bg-white'>
        ...
        <div className='flex flex-row ' >
              <div class="flex flex-col md:w-2/3 w-full p-20 bg-cover bg-hero-pattern2 md:bg-none overflow-hidden" >
                ...
                <div className='py-4'>
                <a href="#" className='mb-2 md:mb-0 mr-5 dark:bg-[#01e473] bg-[#FF6464] rounded-full inline-block px-8 py-3 border border-transparent text-base font-medium text-white hover:opacity-75
