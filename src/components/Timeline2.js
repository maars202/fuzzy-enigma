...
export const Timeline2 = () => {
  return (
    ...
    <Li latest={false} title={"Web Developer Intern"} description={"Worked in a team to develop a Non Fungible Token (NFT) mobile application for art collectibles using solidity, React Native framework and AWS."} 
